...
const greenCarRight = "img/goingRight/green_car_right.png",
  ...
  scooterRight = "img/goingRight/scooter_right.png",
...
export default class Car {
  ...
  collision() {
    if (
      ...
      const message = `<p class="dead-msg">Froggy is dead</p>
                    <img src="./img/web/dead-frog2.png" alt="dead frog" class="dead-img">
