...
let xFrog = 126,
  yFrog = 128,
  frogSize = 16,
  xFrogStart = myCanvas.width / 2 - 7,
  yFrogStart = myCanvas.height - frogSize,
  xJump = 28,
  yJump = frogSize + 4,
  carWidthRight = 35,
  carHeightRight = 25,
...
// Cars going right
const greenCarRight = "img/goingRight/green_car_right.png",
  orangeCarRight = "img/goingRight/oragen_car_right.png",
  ambulanceRight = "img/goingRight/ambulance_right.png",
  blueCarRight = "img/goingRight/blue_car_right.png",
  greenCarLeft = "img/goingLeft/green_car_left.png",
  redCarLeft = "img/goingLeft/red_car_left.png",
  yellowCarLeft = "img/goingLeft/yellow_car_left.png",
  redCarLeft2 = "img/goingLeft/red_car_left2.png",
  yellowBeetleLeft = "img/goingLeft/yellow_beetle_left.png",
  blackWhite = "img/goingLeft/blackWhite.png";
...
function carsAndStreet(
  ...
  const rightCar = laneDirectionRight(
    rightCarsNum,
    streetY + 18,
    rightCarsSpeed
  );
  const leftCar2 = laneDirectionLeft(
    leftCars2Num,
    streetY + 40,
    leftCars2Speed
  );
  const rightCar2 = laneDirectionRight(
    rightCars2Num,
    streetY + 58,
    rightCars2Speed
  );
  const leftCar3 = laneDirectionLeft(
    leftCars3Num,
    streetY + 80,
    leftCars3Speed
  );
  const rightCar3 = laneDirectionRight(
    rightCars3Num,
    streetY + 98,
    rightCars3Speed
  );
  ...
  const traffic = {
    ...
    street: function (yLane) {
      ...
      (streetBorder = line + yLane), (centreLine = 5);
